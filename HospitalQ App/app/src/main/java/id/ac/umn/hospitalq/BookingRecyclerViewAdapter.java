...
public class BookingRecyclerViewAdapter extends RecyclerView.Adapter<BookingRecyclerViewAdapter.BookingRecyclerViewAdminHolder>{
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        ((ListBooking) mContext).refreshlist();
                    }
                });
    ...
    public class BookingRecyclerViewAdminHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v){
            ...
            String email = ListBooking.getEmail();
            String password = ListBooking.getPassword();
            String doctoremail = mDaftarBookings.getDoctor_email();
