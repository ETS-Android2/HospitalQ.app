...
public class RegisterDoctor extends AppCompatActivity {
    ...
    EditText edt_register_email, edt_register_firstname, edt_register_lastname, edt_register_hari
            , edt_register_bulan, edt_register_tahun, edt_register_alamat, edt_register_password, edt_register_departement;
    Button btn_register;
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                regiterUser(edt_register_email.getText().toString(),
                        ...
                        edt_register_departement.getText().toString());
            }
        });
    }
    ...
    private void regiterUser(String email, String password, String firstname, String lastname, int hari,
                             int bulan, int tahun, String alamat, String departement){
        ...
        int userrole = 1;
        compositeDisposable.add(iMyService.registerUser(email,password,firstname,lastname,hari,bulan,tahun,alamat,departement, userrole) //userrole doctor
