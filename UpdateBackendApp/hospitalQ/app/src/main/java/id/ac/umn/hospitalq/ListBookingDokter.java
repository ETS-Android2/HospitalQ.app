...
public class ListBookingDokter  extends AppCompatActivity {
    ...
    private void getBooking(String email, String password){
        ...
        Call<ArrayList<BookingData>> call = iMyService.getBookingDokter(email, password);
        call.enqueue(new Callback<ArrayList<BookingData>>() {
            ...
            public void onResponse(Call<ArrayList<BookingData>> call, Response<ArrayList<BookingData>> response) {
                if (response.isSuccessful()) {
                    ...
                    for (int i = 0; i < mDaftaBooking.size(); i++) {
                        mAdapter = new BookingDokterRecyclerViewAdapter(ListBookingDokter.this, mDaftaBooking);
                        LinearLayoutManager manager = new LinearLayoutManager(ListBookingDokter.this);
            ...
            public void onFailure(Call<ArrayList<BookingData>> call, Throwable t) {
                Toast.makeText(ListBookingDokter.this, "Fail to get data", Toast.LENGTH_SHORT).show();
            }
        });
    }
